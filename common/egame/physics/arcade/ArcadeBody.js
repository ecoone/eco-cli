egame.define("ArcadeBody", ["Arcade"], function(Arcade) {
     ...
     *
     * @class egame.Physics.Arcade.Body
     * @constructor
     * @param {egame.Sprite} sprite - The Sprite object this physics body belongs to.
     */
    egame.Physics.Arcade.Body = function(sprite) {
        /**
         * @property {egame.Sprite} sprite - Reference to the parent Sprite.
         */
        this.sprite = sprite;
         ...
         */
        this.type = egame.Physics.ARCADE;
        ...
        /**
         * @property {egame.Point} offset - The offset of the Physics Body from the Sprite x/y position.
         */
        this.offset = new egame.Point();

        /**
         * @property {egame.Point} position - The position of the physics body.
         * @readonly
         */
        this.position = new egame.Point(sprite.x, sprite.y);

        /**
         * @property {egame.Point} prev - The previous position of the physics body.
         * @readonly
         */
        this.prev = new egame.Point(this.position.x, this.position.y);
        ...
        /**
         * @property {egame.Point} center - The center coordinate of the Physics Body.
         * @readonly
         */
        this.center = new egame.Point(sprite.x + this.halfWidth, sprite.y + this.halfHeight);

        /**
         * @property {egame.Point} velocity - The velocity, or rate of change in speed of the Body. Measured in pixels per second.
         */
        this.velocity = new egame.Point();

        /**
         * @property {egame.Point} newVelocity - The new velocity. Calculated during the Body.preUpdate and applied to its position.
         * @readonly
         */
        this.newVelocity = new egame.Point(0, 0);

        /**
         * @property {egame.Point} deltaMax - The Sprite position is updated based on the delta x/y values. You can set a cap on those (both +-) using deltaMax.
         */
        this.deltaMax = new egame.Point(0, 0);

        /**
         * @property {egame.Point} acceleration - The acceleration is the rate of change of the velocity. Measured in pixels per second squared.
         */
        this.acceleration = new egame.Point();

        /**
         * @property {egame.Point} drag - The drag applied to the motion of the Body.
         */
        this.drag = new egame.Point();
        ...
        /**
         * @property {egame.Point} gravity - A local gravity applied to this Body. If non-zero this over rides any world gravity, unless Body.allowGravity is set to false.
         */
        this.gravity = new egame.Point(0, 0);

        /**
         * @property {egame.Point} bounce - The elasticity of the Body when colliding. bounce.x/y = 1 means full rebound, bounce.x/y = 0.5 means 50% rebound velocity.
         */
        this.bounce = new egame.Point();

        /**
         * @property {egame.Point} maxVelocity - The maximum velocity in pixels per second sq. that the Body can reach.
         * @default
         */
        this.maxVelocity = new egame.Point(10000, 10000);

        /**
         * @property {egame.Point} friction - The amount of movement that will occur if another object 'rides' this one.
         */
        this.friction = new egame.Point(1, 0);
         ...
         * @property {egame.Point} tilePadding - Extra padding to be added to this sprite's dimensions when checking for tile collision.
         */
        this.tilePadding = new egame.Point();
    ...
    egame.Physics.Arcade.Body.prototype = {
        /**
        * Internal method.
        *
        ...
        */
         ...
         * Internal method.
         *
         * @method egame.Physics.Arcade.Body#postUpdate
         * @protected
         */
        postUpdate: function() {
            ...
            if (this.deltaX() < 0) {
                this.facing = egame.LEFT;
            } else if (this.deltaX() > 0) {
                this.facing = egame.RIGHT;
            }

            if (this.deltaY() < 0) {
                this.facing = egame.UP;
            } else if (this.deltaY() > 0) {
                this.facing = egame.DOWN;
            }
         ...
         *
         * @method egame.Physics.Arcade.Body#destroy
         */
        destroy: function() {

            if (this.sprite.parent && this.sprite.parent instanceof egame.Group) {
         ...
         * Internal method.
         *
         * @method egame.Physics.Arcade.Body#checkWorldBounds
         * @protected
         */
         ...
         *
         * @method egame.Physics.Arcade.Body#setSize
         ...
         *
         * @method egame.Physics.Arcade.Body#reset
         ...
         *
         * @method egame.Physics.Arcade.Body#onWall
         * @return {boolean} True if in contact with either the world bounds or a tile.
         */
        onWall: function() {
         ...
         *
         * @method egame.Physics.Arcade.Body#deltaAbsX
         ...
         *
         * @method egame.Physics.Arcade.Body#deltaAbsY
         * @return {number} The absolute delta value.
         */
        deltaAbsY: function() {
         ...
         *
         * @method egame.Physics.Arcade.Body#deltaX
         ...
         *
         * @method egame.Physics.Arcade.Body#deltaY
         ...
         *
         * @method egame.Physics.Arcade.Body#deltaZ
    ...
    /**
     * @name egame.Physics.Arcade.Body#bottom
     * @property {number} bottom - The bottom value of this Body (same as Body.y + Body.height)
     * @readonly
     */
    Object.defineProperty(egame.Physics.Arcade.Body.prototype, "bottom", {
    ...
    /**
     * @name egame.Physics.Arcade.Body#right
     * @property {number} right - The right value of this Body (same as Body.x + Body.width)
     * @readonly
     */
    Object.defineProperty(egame.Physics.Arcade.Body.prototype, "right", {
    ...
    /**
     * @name egame.Physics.Arcade.Body#x
     * @property {number} x - The x position.
     */
    Object.defineProperty(egame.Physics.Arcade.Body.prototype, "x", {
    ...
    /**
     * @name egame.Physics.Arcade.Body#y
     * @property {number} y - The y position.
     */
    Object.defineProperty(egame.Physics.Arcade.Body.prototype, "y", {
     ...
     * Render Sprite Body.
     *
     * @method egame.Physics.Arcade.Body#render
     * @param {object} context - The context to render to.
     * @param {egame.Physics.Arcade.Body} body - The Body to render the info of.
     ...
     *
     * @method egame.Physics.Arcade.Body#renderBodyInfo
     * @param {egame.Physics.Arcade.Body} body - The Body to render the info of.
     * @param {number} x - X position of the debug info to be rendered.
     * @param {number} y - Y position of the debug info to be rendered.
     * @param {string} [color='rgb(255,255,255)'] - color of the debug info to be rendered. (format is css color string).
     */
    egame.Physics.Arcade.Body.renderBodyInfo = function(debug, body) {
    ...
    egame.Physics.Arcade.Body.prototype.constructor = egame.Physics.Arcade.Body;

    return egame.Physics.Arcade.Body;
});