egame.define("Reset", ["Component"], function(Component) {
     ...
     * @class
     */
    egame.Component.Reset = function() {};
     ...
     * @return {egame.DisplayObject} This instance.
     */
    egame.Component.Reset.prototype.reset = function(x, y, health) {
