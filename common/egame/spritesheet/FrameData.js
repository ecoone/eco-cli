egame.define("FrameData",["Frame"],function(Frame) {
    /**
     * FrameData is a container for Frame objects, which are the internal representation of animation data in egame.
     *
     * @class egame.FrameData
     * @constructor
     */
    egame.FrameData = function() {
        ...
        /**
         * @property {Array} _frameNames -用于帧的名字和索引的转换
         * @private
         */
        this._frameNames = [];
    ...
    egame.FrameData.prototype = {

        /**
         * Adds a new Frame to this FrameData collection. Typically called by the Animation.Parser and not directly.
         *
         * @method egame.FrameData#addFrame
         * @param {egame.Frame} frame - The frame to add to this FrameData set.
         * @return {egame.Frame} The frame that was just added.
         */
         ...
         *
         * @method egame.FrameData#getFrame
         * @param {number} index - The index of the frame you want to get.
         * @return {egame.Frame} The frame, if found.
         */
         ...
         *
         * @method egame.FrameData#getFrameByName
         ...
         *
         * @method egame.FrameData#checkFrameName
         ...
         *
         * @method egame.FrameData#clone
         * @return {egame.FrameData} A clone of this object, including clones of the Frame objects it contains.
         */
        clone: function() {

            var output = new egame.FrameData();
         ...
         *
         * @method egame.FrameData#getFrameRange
         ...
         *
         * @method egame.FrameData#getFrames
         ...
         *
         * @method egame.FrameData#getFrameIndexes
    ...
    egame.FrameData.prototype.constructor = egame.FrameData;

    /**
     * @name egame.FrameData#total
     * @property {number} total - The total number of frames in this FrameData set.
     * @readonly
     */
    Object.defineProperty(egame.FrameData.prototype, "total", {
