egame.define("TweenData", function() {
    var o = {
     ...
     *
     * @class egame.TweenData
     * @constructor
     * @param {egame.Tween} parent - The Tween that owns this TweenData object.
     */
    egame.TweenData = function(parent) {

        /**
         * @property {egame.Tween} parent - The Tween which owns this TweenData.
         */
        this.parent = parent;
         ...
         * @default egame.Easing.Default
         */
        this.easingFunction = egame.Easing.Default;

        /**
         * @property {function} interpolationFunction - The interpolation function used for the Tween.
         * @default egame.Math.linearInterpolation
         */
        this.interpolationFunction = o.linearInterpolation;

        /**
         * @property {object} interpolationContext - The interpolation function context used for the Tween.
         * @default egame.Math
         */
        this.interpolationContext = o;

        /**
         * @property {boolean} isRunning - If the tween is running this is set to `true`. Unless egame.Tween a TweenData that is waiting for a delay to expire is *not* considered as running.
         * @default
         */
     ...
     * @type {number}
     */
    egame.TweenData.PENDING = 0;

    /**
     * @constant
     * @type {number}
     */
    egame.TweenData.RUNNING = 1;

    /**
     * @constant
     * @type {number}
     */
    egame.TweenData.LOOPED = 2;

    /**
     * @constant
     * @type {number}
     */
    egame.TweenData.COMPLETE = 3;

    egame.TweenData.prototype = {

        /**
         * Sets this tween to be a `to` tween on the properties given. A `to` tween starts at the current value and tweens to the destination value given.
         * For example a Sprite with an `x` coordinate of 100 could be tweened to `x` 200 by giving a properties object of `{ x: 200 }`.
         *
         * @method egame.TweenData#to
         ...
         * @param {function} [ease=null] - Easing function. If not set it will default to egame.Easing.Default, which is egame.Easing.Linear.None by default but can be over-ridden at will.
         ...
         * @return {egame.TweenData} This Tween object.
         */
         ...
         *
         * @private
         * @method egame.TweenData#loadValues
         * @return {egame.TweenData} This Tween object.
         */
        loadValues: function() {
        ...
        /**
         * Updates this Tween. This is called automatically by egame.Tween.
         *
         * @protected
         * @method egame.TweenData#update
         * @param {number} time - A timestamp passed in by the Tween parent.
         * @return {number} The current status of this Tween. One of the egame.TweenData constants: PENDING, RUNNING, LOOPED or COMPLETE.
         */
        update: function(time) {
            ...
            if (!this.isRunning) {
                if (time >= this.startTime) {
                    ...
                    return egame.TweenData.PENDING;
                }
            } else {
                //  Is Running, but is waiting to repeat
                if (time < this.startTime) {
                    return egame.TweenData.RUNNING;
                }
            }
         ...
         *
         * @method egame.TweenData#generateData
         ...
         *
         * @private
         * @method egame.TweenData#repeat
         * @return {number} Either egame.TweenData.LOOPED or egame.TweenData.COMPLETE.
         */
        repeat: function() {
            ...
            if (this.yoyo) {
                ...
                if (this.inReverse && this.repeatCounter === 0) {
                    return egame.TweenData.COMPLETE;
                }
            ...
            return egame.TweenData.LOOPED;

        }

    };

    egame.TweenData.prototype.constructor = egame.TweenData;

    return egame.TweenData;
});