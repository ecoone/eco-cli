egame.define("Tween", ["TweenData", "Easing", "EventEmitter"], function(TweenData, Easing, EventEmitter) {
    ...
    egame.Tween = function(target, game, manager) {
        ...
        /**
         * @property {object} target - The target object, such as a egame.Sprite or property like egame.Sprite.scale.
         */
        this.target = target;

        /**
         * @property {egame.TweenManager} manager - Reference to the TweenManager responsible for updating this Tween.
         */
        ...
        /**
         * @property {egame.Tween} chainedTween - If this Tween is chained to another this holds a reference to it.
         */
    ...
    egame.util.extend(egame.Tween.prototype, {
         ...
         * The ease function allows you define the rate of change. You can pass either a function such as egame.Easing.Circular.Out or a string such as "Circ".
         * ".easeIn", ".easeOut" and "easeInOut" variants are all supported for all ease types.
         *
         * @method egame.Tween#to
         ...
         * @param {function|string} [ease=null] - Easing function. If not set it will default to egame.Easing.Default, which is egame.Easing.Linear.None by default but can be over-ridden.
         ...
         * @return {egame.Tween} This Tween object.
         */
        to: function(properties, duration, ease, autoStart, delay, repeat, yoyo) {
            ...
            if (this.isRunning) {
                console.warn('egame.Tween.to cannot be called after Tween.start');
                return this;
            }

            this.timeline.push(new egame.TweenData(this).to(properties, duration, ease, delay, repeat, yoyo));
        ...
        from: function(properties, duration, ease, autoStart, delay, repeat, yoyo) {
            ...
            if (this.isRunning) {
                console.warn('egame.Tween.from cannot be called after Tween.start');
                return this;
            }

            this.timeline.push(new egame.TweenData(this).from(properties, duration, ease, delay, repeat, yoyo));
         ...
         * @return {egame.Tween} This tween. Useful for method chaining.
         */
         ...
         *
         * @method egame.Tween#updateTweenData
         ...
         *
         * @method egame.Tween#repeatDelay
        ...
        /**
         * Set easing function this tween will use, i.e. egame.Easing.Linear.None.
         * The ease function allows you define the rate of change. You can pass either a function such as egame.Easing.Circular.Out or a string such as "Circ".
         * ".easeIn", ".easeOut" and "easeInOut" variants are all supported for all ease types.
         * If you have child tweens and pass -1 as the index value it sets the easing function defined here across all of them.
         *
         * @method egame.Tween#easing
         * @param {function|string} ease - The easing function this tween will use, i.e. egame.Easing.Linear.None.
        ...
        /**
         * Sets the interpolation function the tween will use. By default it uses egame.Math.linearInterpolation.
         * Also available: egame.Math.bezierInterpolation and egame.Math.catmullRomInterpolation.
         ...
         *
         * @method egame.Tween#interpolation
         * @param {function} interpolation - The interpolation function to use (egame.Math.linearInterpolation by default)
         ...
         *
         * @method egame.Tween#chain
         * @param {...egame.Tween} tweens - One or more tweens that will be chained to this one.
         * @return {egame.Tween} This tween. Useful for method chaining.
         */
        chain: function() {
         ...
         *
         * Usage:
         * game.add.tween(p).to({ x: 700 }, 1000, egame.Easing.Linear.None, true)
         * .to({ y: 300 }, 1000, egame.Easing.Linear.None)
         * .to({ x: 0 }, 1000, egame.Easing.Linear.None)
         * .to({ y: 0 }, 1000, egame.Easing.Linear.None)
         * .loop();
         * @method egame.Tween#loop
         ...
         *
         * @method egame.Tween#onUpdateCallback
        ...
        update: function(time) {
            ...
            if (status === egame.TweenData.PENDING) {
                return true;
         ...
         *
         * @method egame.Tween#generateData
     ...
     * @property {egame.TweenData} totalDuration - Gets the total duration of this Tween, including all child tweens, in milliseconds.
     */
    Object.defineProperty(egame.Tween.prototype, 'totalDuration', {
    ...
    egame.Tween.prototype.constructor = egame.Tween;
