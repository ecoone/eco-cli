egame.define("Tilemap",["Tile","TilemapParser","Group","Tileset"],function(Tile,TilemapParser,Group,Tileset) {

    /**
     * Creates a new egame.Tilemap object. The map can either be populated with data from a Tiled JSON file or from a CSV file.
     ...
     * @class egame.Tilemap
     * @constructor
     * @param {egame.Game} game - Game reference to the currently running game.
     ...
     */
    egame.Tilemap = function(game, key, tileWidth, tileHeight, width, height) {
        ...
        /**
         * @property {string} key - The key of this map data in the egame.Cache.
         */
        this.key = key;

        var data = egame.TilemapParser.parse(this.game, key, tileWidth, tileHeight, width, height);
        ...
        /**
         * @property {number} format - The format of the map data, either egame.Tilemap.CSV or egame.Tilemap.TILED_JSON.
         */
     ...
     * @type {number}
     */
    egame.Tilemap.TILED_JSON = 1;

    /**
     * @constant
     * @type {number}
     */
    egame.Tilemap.NORTH = 0;

    /**
     * @constant
     * @type {number}
     */
    egame.Tilemap.EAST = 1;

    /**
     * @constant
     * @type {number}
     */
    egame.Tilemap.SOUTH = 2;

    /**
     * @constant
     * @type {number}
     */
    egame.Tilemap.WEST = 3;

    egame.Tilemap.prototype = {

        /**
         * Creates an empty map of the given dimensions and one blank layer. If layers already exist they are erased.
         *
         * @method egame.Tilemap#create
         ...
         * @param {egame.Group} [group] - Optional Group to add the layer to. If not specified it will be added to the World group.
         * @return {egame.TilemapLayer} The TilemapLayer object. This is an extension of egame.Image and can be moved around the display list accordingly.
         */
         ...
         *
         * @method egame.Tilemap#setTileSize
         * @param {number} tileWidth - The width of the tiles the map uses for calculations.
         * @param {number} tileHeight - The height of the tiles the map uses for calculations.
         */
         ...
         *
         * @method egame.Tilemap#addTilesetImage
         * @param {string} tileset - The name of the tileset as specified in the map data.
         * @param {string|egame.BitmapData} [key] - The key of the egame.Cache image used for this tileset.
         ...
         * @return {egame.Tileset} Returns the Tileset object that was created or updated, or null if it failed.
         */
        addTilesetImage: function(tileset, key, tileWidth, tileHeight, tileMargin, tileSpacing, gid) {
            ...
            // if (key instanceof egame.BitmapData) {
            //     img = key.canvas;
            // } else {
            //     if (!this.game.cache.checkImageKey(key)) {
            //         console.warn('egame.Tilemap.addTilesetImage: Invalid image key given: "' + key + '"');
            //         return null;
            //     }

                // img = this.game.cache.getImage(key);
            // }
            img =  egame.Caches[key].data;//NIU

            var idx = this.getTilesetIndex(tileset);

            if (idx === null && this.format === egame.Tilemap.TILED_JSON) {
                console.warn('egame.Tilemap.addTilesetImage: No data found in the JSON matching the tileset name: "' + tileset + '"');
                return null;
            }
            ...
            if (this.tilesets[idx]) {
                ...
                var newSet = new egame.Tileset(tileset, gid, tileWidth, tileHeight, tileMargin, tileSpacing, {});
         ...
         *
         * @method egame.Tilemap#createFromObjects
         ...
         * @param {egame.Group} [group=egame.World] - Group to add the Sprite to. If not specified it will be added to the World group.
         * @param {object} [CustomClass=egame.Sprite] - If you wish to create your own class, rather than egame.Sprite, pass the class here. Your class must extend egame.Sprite and have the same constructor parameters.
         * @param {boolean} [adjustY=true] - By default the Tiled map editor uses a bottom-left coordinate system. egame uses top-left. So most objects will appear too low down. This parameter moves them up by their height.
         */
         ...
         *
         * @method egame.Tilemap#createFromTiles
         ...
         * @param {string} key - The Game.cache key of the image that this Sprite will use.
         * @param {number|string|egame.TilemapLayer} [layer] - The layer to operate on.
         * @param {egame.Group} [group=egame.World] - Group to add the Sprite to. If not specified it will be added to the World group.
        ...
        createFromTiles: function(tiles, replacements, key, layer, group, properties) {
            ...
            if (properties.customClass === undefined) {
                properties.customClass = egame.Sprite;
            }
         ...
         *
         * @method egame.Tilemap#createLayer
         ...
         * @param {egame.Group} [group] - Optional Group to add the object to. If not specified it will be added to the World group.
         * @return {egame.TilemapLayer} The TilemapLayer object. This is an extension of egame.Sprite and can be moved around the display list accordingly.
         */
        createLayer: function(layer, width, height, group) {
            ...
            return group.add(new egame.TilemapLayer(this.game, this, index, width, height));
         ...
         *
         * @method egame.Tilemap#createBlankLayer
        ...
        createBlankLayer: function(name, width, height, tileWidth, tileHeight, group) {
            ...
            for (var y = 0; y < height; y++) {
                ...
                for (var x = 0; x < width; x++) {
                    // row.push(null);
                    row.push(new egame.Tile(layer, -1, x, y, tileWidth, tileHeight));
                }
            ...
            var output = new egame.TilemapLayer(this.game, this, this.layers.length - 1, w, h);
            output.name = name;
         ...
         *
         * @method egame.Tilemap#getLayerIndex
         ...
         *
         * @method egame.Tilemap#getTilesetIndex
         ...
         *
         * @method egame.Tilemap#getImageIndex
         ...
         *
         * @method egame.Tilemap#setTileIndexCallback
         ...
         * @param {number|string|egame.TilemapLayer} [layer] - The layer to operate on. If not given will default to this.currentLayer.
         */
         ...
         * If you want to set a callback for a tile at a specific location on the map then see setTileLocationCallback.
         *
         * @method egame.Tilemap#setTileLocationCallback
         ...
         *
         * @method egame.Tilemap#setCollision
         ...
         * The `collides` parameter controls if collision will be enabled (true) or disabled (false).
         *
         * @method egame.Tilemap#setCollisionBetween
         ...
         * The `collides` parameter controls if collision will be enabled (true) or disabled (false).
         *
         * @method egame.Tilemap#setCollisionByExclusion
         ...
         *
         * @method egame.Tilemap#setCollisionByIndex
         * @protected
        ...
        getLayer: function(layer) {
            ...
            } else if (layer instanceof egame.TilemapLayer) {
                layer = layer.index;
            }
         ...
         *
         * @method egame.Tilemap#setPreventRecalculate
         ...
         * Internal function.
         *
         * @method egame.Tilemap#calculateFaces
         * @protected
         ...
         *
         * @method egame.Tilemap#getTileAbove
         ...
         * Mostly used as an internal function by calculateFaces.
         *
         * @method egame.Tilemap#getTileBelow
         * @param {number} layer - The local layer index to get the tile from. Can be determined by Tilemap.getLayer().
         * @param {number} x - The x coordinate to get the tile from. In tiles, not pixels.
         * @param {number} y - The y coordinate to get the tile from. In tiles, not pixels.
         */
         ...
         * Mostly used as an internal function by calculateFaces.
         *
         * @method egame.Tilemap#getTileLeft
         * @param {number} layer - The local layer index to get the tile from. Can be determined by Tilemap.getLayer().
         * @param {number} x - The x coordinate to get the tile from. In tiles, not pixels.
         * @param {number} y - The y coordinate to get the tile from. In tiles, not pixels.
         */
         ...
         * Mostly used as an internal function by calculateFaces.
         *
         * @method egame.Tilemap#getTileRight
         * @param {number} layer - The local layer index to get the tile from. Can be determined by Tilemap.getLayer().
         * @param {number} x - The x coordinate to get the tile from. In tiles, not pixels.
         * @param {number} y - The y coordinate to get the tile from. In tiles, not pixels.
         */
         ...
         *
         * @method egame.Tilemap#setLayer
         * @param {number|string|egame.TilemapLayer} layer - The layer to set as current.
         */
         ...
         *
         * @method egame.Tilemap#removeTile
         ...
         * @param {number|string|egame.TilemapLayer} [layer] - The layer to modify.
         * @return {egame.Tile} The Tile object that was removed from this map.
         */
        removeTile: function(x, y, layer) {
            ...
            if (x >= 0 && x < this.layers[layer].width && y >= 0 && y < this.layers[layer].height) {
                if (this.hasTile(x, y, layer)) {
                    ...
                    this.layers[layer].data[y][x] = new egame.Tile(this.layers[layer], -1, x, y, this.tileWidth, this.tileHeight);
         ...
         *
         * @method egame.Tilemap#removeTileWorldXY
         ...
         *
         * @method egame.Tilemap#putTile
         * @param {egame.Tile|number|null} tile - The index of this tile to set or a egame.Tile object. If null the tile is removed from the map.
         * @param {number} x - X position to place the tile (given in tile units, not pixels)
         * @param {number} y - Y position to place the tile (given in tile units, not pixels)
         * @param {number|string|egame.TilemapLayer} [layer] - The layer to modify.
         * @return {egame.Tile} The Tile object that was created or added to this map.
         */
        putTile: function(tile, x, y, layer) {
            ...
            if (x >= 0 && x < this.layers[layer].width && y >= 0 && y < this.layers[layer].height) {
                ...
                if (tile instanceof egame.Tile) {
                    index = tile.index;

                    if (this.hasTile(x, y, layer)) {
                        this.layers[layer].data[y][x].copy(tile);
                    } else {
                        this.layers[layer].data[y][x] = new egame.Tile(layer, index, x, y, tile.width, tile.height);
                    }
                } else {
                    index = tile;
                    ...
                    if (this.hasTile(x, y, layer)) {
                        ...
                        this.layers[layer].data[y][x] = new egame.Tile(this.layers[layer], index, x, y, this.tileWidth, this.tileHeight);
                    }
                }
         ...
         *
         * @method egame.Tilemap#putTileWorldXY
         * @param {egame.Tile|number} tile - The index of this tile to set or a egame.Tile object.
         * @param {number} x - X position to insert the tile (given in pixels)
         * @param {number} y - Y position to insert the tile (given in pixels)
         * @param {number} tileWidth - The width of the tile in pixels.
         * @param {number} tileHeight - The height of the tile in pixels.
        ...
        /**
         * Searches the entire map layer for the first tile matching the given index, then returns that egame.Tile object.
         ...
         *
         * @method egame.Tilemap#searchTileIndex
         ...
         * @param {number|string|egame.TilemapLayer} [layer] - The layer to get the tile from.
         * @return {egame.Tile} The first (or n skipped) tile with the matching index.
         */
         ...
         * @return {egame.Tile} The tile at the given coordinates or null if no tile was found or the coordinates were invalid.
         */
         ...
         *
         * @method egame.Tilemap#getTileWorldXY
         ...
         * @param {number|string|egame.TilemapLayer} [layer] - The layer to get the tile from.
         * @param {boolean} [nonNull=false] - If true getTile won't return null for empty tiles, but a Tile object with an index of -1.
         * @return {egame.Tile} The tile at the given coordinates.
         */
         ...
         * @param {integer|string|egame.TilemapLayer} [layer] - The layer to copy the tiles from.
         ...
         * @param {number|string|egame.TilemapLayer} [layer] - The layer to paste the tiles into.
         */
         ...
         *
         * @method egame.Tilemap#swapHandler
         * @private
         * @param {number} value
         */
        ...
        shuffle: function(x, y, width, height, layer) {
            ...
            egame.ArrayUtils.shuffle(indexes);
         ...
         *
         * @method egame.Tilemap#removeAllLayers
         */
    ...
    egame.Tilemap.prototype.constructor = egame.Tilemap;

    /**
     * @name egame.Tilemap#layer
     * @property {number|string|egame.TilemapLayer} layer - The current layer object.
     */
    Object.defineProperty(egame.Tilemap.prototype, "layer", {
