egame.define("TilemapLayer",["Sprite","CanvasBuffer"],function(Sprite,CanvasBuffer) {
/**
* A TilemapLayer is a egame.Image/Sprite that renders a specific TileLayer of a Tilemap.
*
...
*
* @class egame.TilemapLayer
* @extends egame.Sprite
* @constructor
* @param {egame.Game} game - Game reference to the currently running game.
* @param {egame.Tilemap} tilemap - The tilemap to which this layer belongs.
...
*/
egame.TilemapLayer = function (game, tilemap, index, width, height) {
    this.game = game;
    width |= 0;
    height |= 0;

    egame.Sprite.call(this);

    /**
    * The Tilemap to which this layer is bound.
    * @property {egame.Tilemap} map
    * @protected
    * @readonly
    */
    this.map = tilemap;
    ...
    * @protected
    */
    this.canvas = (new CanvasBuffer(width, height)).canvas;
    ...
    */
    ...
    this.texture =new egame.Texture(new egame.BaseTexture(this.canvas));
    ...
    * @readonly
    * @protected
    * @default egame.TILEMAPLAYER
    */
    this.type = egame.TILEMAPLAYER;

    /**
    * @property {number} physicsType - The const physics body type of this object.
    * @readonly
    */
    this.physicsType = egame.TILEMAPLAYER;
    ...
    */
    ...
    // {
        this.renderSettings.copyCanvas = egame.TilemapLayer.ensureSharedCopyCanvas();
    // }
...
egame.TilemapLayer.prototype = Object.create(egame.Sprite.prototype);
egame.TilemapLayer.prototype.constructor = egame.TilemapLayer;

// egame.TilemapLayer.prototype.preUpdateCore = egame.Component.Core.preUpdate;
...
* @static
*/
egame.TilemapLayer.sharedCopyCanvas = null;
...
*
* @method egame.TilemapLayer#ensureSharedCopyCanvas
* @protected
* @static
*/
egame.TilemapLayer.ensureSharedCopyCanvas = function () {

    if (!this.sharedCopyCanvas)
    {
        this.sharedCopyCanvas = (new CanvasBuffer(2, 2)).canvas;
    }
...
/**
* Automatically called by World.preUpdate.NIU
*
* @method egame.TilemapLayer#preUpdate
*/
// egame.TilemapLayer.prototype.preUpdate = function() {
...
*
* @method egame.TilemapLayer#postUpdate
* @protected
*/
egame.TilemapLayer.prototype.postUpdate = function () {
...
*
* @method egame.TilemapLayer#destroy
*/
egame.TilemapLayer.prototype.destroy = function() {
    // PIXI.CanvasPool.remove(this);
    this.canvas = null;
    egame.Component.Destroy.prototype.destroy.call(this);
...
*
* @method egame.TilemapLayer#resizeWorld
* @public
*/
egame.TilemapLayer.prototype.resizeWorld = function () {
...
*
* @method egame.TilemapLayer#_fixX
* @private
* @param {number} x - x coordinate in camera space
* @return {number} x coordinate in scrollFactor-adjusted dimensions
*/
egame.TilemapLayer.prototype._fixX = function (x) {
...
*
* @method egame.TilemapLayer#_unfixX
* @private
* @param {number} x - x coordinate in scrollFactor-adjusted dimensions
* @return {number} x coordinate in camera space
*/
egame.TilemapLayer.prototype._unfixX = function (x) {
...
*
* @method egame.TilemapLayer#_fixY
* @private
* @param {number} y - y coordinate in camera space
* @return {number} y coordinate in scrollFactor-adjusted dimensions
*/
egame.TilemapLayer.prototype._fixY = function (y) {
...
*
* @method egame.TilemapLayer#_unfixY
* @private
* @param {number} y - y coordinate in scrollFactor-adjusted dimensions
* @return {number} y coordinate in camera space
*/
egame.TilemapLayer.prototype._unfixY = function (y) {
...
*
* @method egame.TilemapLayer#getTileXY
* @public
* @param {number} x - X position of the point in target tile (in pixels).
* @param {number} y - Y position of the point in target tile (in pixels).
* @param {(egame.Point|object)} point - The Point/object to update.
* @return {(egame.Point|object)} A Point/object with its `x` and `y` properties set.
*/
egame.TilemapLayer.prototype.getTileXY = function (x, y, point) {
...
*
* @method egame.TilemapLayer#getRayCastTiles
* @public
* @param {egame.Line} line - The line used to determine which tiles to return.
...
* @return {egame.Tile[]} An array of egame.Tiles.
*/
egame.TilemapLayer.prototype.getRayCastTiles = function (line, stepRate, collides, interestingFace) {
...
*
* @method egame.TilemapLayer#getTiles
* @public
...
* @param {boolean} [collides=false] - If true, _only_ return tiles that collide on one or more faces.
* @param {boolean} [interestingFace=false] - If true, _only_ return tiles that have interesting faces.
* @return {array<egame.Tile>} An array of Tiles.
*/
egame.TilemapLayer.prototype.getTiles = function (x, y, width, height, collides, interestingFace) {
...
*
* @method egame.TilemapLayer#resolveTileset
* @private
* @param {integer} Tile index
* @return {egame.Tileset|null} Returns the associated tileset or null if there is no such mapping.
*/
egame.TilemapLayer.prototype.resolveTileset = function (tileIndex) {
...
*
* @method egame.TilemapLayer#resetTilesetCache
* @public
*/
egame.TilemapLayer.prototype.resetTilesetCache = function () {
...
*
* @method egame.TilemapLayer#shiftCanvas
* @private
* @param {CanvasRenderingContext2D} context - The context to shift
* @param {integer} x
* @param {integer} y
*/
egame.TilemapLayer.prototype.shiftCanvas = function (context, x, y) {
...
*
* @method egame.TilemapLayer#renderRegion
* @private
...
*/
egame.TilemapLayer.prototype.renderRegion = function (scrollX, scrollY, left, top, right, bottom) {
...
*
* @method egame.TilemapLayer#renderDeltaScroll
* @private
*/
egame.TilemapLayer.prototype.renderDeltaScroll = function (shiftX, shiftY) {
...
*
* @method egame.TilemapLayer#renderFull
* @private
*/
egame.TilemapLayer.prototype.renderFull = function () {
...
*
* @method egame.TilemapLayer#render
* @protected
*/
egame.TilemapLayer.prototype.render = function () {
...
*
* @method egame.TilemapLayer#renderDebug
* @private
*/
egame.TilemapLayer.prototype.renderDebug = function () {
...
* @memberof egame.TilemapLayer
* @public
* @default false
*/
Object.defineProperty(egame.TilemapLayer.prototype, "wrap", {
...
* @public
*/
Object.defineProperty(egame.TilemapLayer.prototype, "scrollX", {
...
* @public
*/
Object.defineProperty(egame.TilemapLayer.prototype, "scrollY", {
...
* @public
*/
Object.defineProperty(egame.TilemapLayer.prototype, "collisionWidth", {
...
* @public
*/
Object.defineProperty(egame.TilemapLayer.prototype, "collisionHeight", {
