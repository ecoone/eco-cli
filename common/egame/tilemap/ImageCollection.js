egame.define("ImageCollection", function() {
     ...
     */
    egame.ImageCollection = function(name, firstgid, width, height, margin, spacing, properties) {
    ...
    egame.ImageCollection.prototype = {

        /**
         * Returns true if and only if this image collection contains the given image index.
         *
         * @method egame.ImageCollection#containsImageIndex
         ...
         *
         * @method egame.ImageCollection#addImage
    ...
    egame.ImageCollection.prototype.constructor = egame.ImageCollection;

    return egame.ImageCollection;
});