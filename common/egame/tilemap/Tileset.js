egame.define("Tileset", function() {
     ...
     */
    egame.Tileset = function(name, firstgid, width, height, margin, spacing, properties) {
        ...
        /**
         * The cached image that contains the individual tiles. Use {@link egame.Tileset.setImage setImage} to set.
    ...
    egame.Tileset.prototype = {
         ...
         *
         * @method egame.Tileset#containsTileIndex
         * @public
         ...
         *
         * @method egame.Tileset#setSpacing
         * @public
         ...
         *
         * @method egame.Tileset#updateTileData
         * @private
        ...
        updateTileData: function(imageWidth, imageHeight) {
            ...
            if (rowCount % 1 !== 0 || colCount % 1 !== 0) {
                console.warn("egame.Tileset - image tile area is not an even multiple of tile size");
            }
            ...
            if ((this.rows && this.rows !== rowCount) || (this.columns && this.columns !== colCount)) {
                console.warn("egame.Tileset - actual and expected number of tile rows and columns differ");
            }
    ...
    egame.Tileset.prototype.constructor = egame.Tileset;

    return egame.Tileset;
});