egame.define("Emitter", ["Particles", "CONST", "Group", "RandomDataGenerator", "Particle"], function(Particles, CONST, Group, RandomDataGenerator, Particle) {
    /**
     * Arcade Particles is a Particle System integrated with Arcade Physics.
     *
     * @class Phaser.Particles.Arcade
     */
    egame.Particles.Arcade = {};
     ...
     * 
     * @class egame.Particles.Arcade.Emitter
     * @constructor
     * @extends egame.Group
     * @param {egame.Game} game - Current game instance.
     * @param {number} [x=0] - The x coordinate within the Emitter that the particles are emitted from.
     * @param {number} [y=0] - The y coordinate within the Emitter that the particles are emitted from.
     * @param {number} [maxParticles=50] - The total number of particles in this emitter.
     */
    egame.Particles.Arcade.Emitter = function(game, x, y, maxParticles) {
        ...
        /**
         * @property {number} type - Internal egame Type value.
         * @protected
         */
        this.type = egame.EMITTER;
        ...
        /**
         * @property {egame.Rectangle} area - The area of the emitter. Particles can be randomly generated from anywhere within this rectangle.
         * @default
         */
        this.area = new egame.Rectangle(x, y, 1, 1);

        /**
         * @property {egame.Point} minParticleSpeed - The minimum possible velocity of a particle.
         * @default
         */
        this.minParticleSpeed = new egame.Point(-100, -100);

        /**
         * @property {egame.Point} maxParticleSpeed - The maximum possible velocity of a particle.
         * @default
         */
        this.maxParticleSpeed = new egame.Point(100, 100);
        ...
        /**
         * @property {any} particleClass - For emitting your own particle class types. They must extend egame.Particle.
         * @default
         */
        this.particleClass = egame.Particle;

        /**
         * @property {egame.Point} particleDrag - The X and Y drag component of particles launched from the emitter.
         */
        this.particleDrag = new egame.Point();
        ...
        /**
         * @property {egame.Point} bounce - How much each particle should bounce on each axis. 1 = full bounce, 0 = no bounce.
         */
        this.bounce = new egame.Point();
        ...
        /**
         * @property {egame.Point} particleAnchor - When a particle is created its anchor will be set to match this Point object (defaults to x/y: 0.5 to aid in rotation)
         * @default
         */
        this.particleAnchor = new egame.Point(0.5, 0.5);
         ...
         * @default
         */
        // this.blendMode = egame.blendModes.NORMAL; 
        this.blendMode = CONST.BLEND_MODES.NORMAL; //add by NIU
        ...
        /**
         * @property {egame.Point} _minParticleScale - Internal particle scale var.
         * @private
         */
        this._minParticleScale = new egame.Point(1, 1);

        /**
         * @property {egame.Point} _maxParticleScale - Internal particle scale var.
         * @private
         */
        this._maxParticleScale = new egame.Point(1, 1);
    ...
    egame.Particles.Arcade.Emitter.prototype = Object.create(egame.Group.prototype);
    egame.Particles.Arcade.Emitter.prototype.constructor = egame.Particles.Arcade.Emitter;

    /**
     * Called automatically by the game loop, decides when to launch particles and when to "die".
     * 
     * @method egame.Particles.Arcade.Emitter#update
     */
    egame.Particles.Arcade.Emitter.prototype.update = function() {
     ...
     *
     * @method egame.Particles.Arcade.Emitter#kill
     */
    egame.Particles.Arcade.Emitter.prototype.kill = function() {
     ...
     *
     * @method egame.Particles.Arcade.Emitter#revive
     */
    egame.Particles.Arcade.Emitter.prototype.revive = function() {
     ...
     * 
     * @method egame.Particles.Arcade.Emitter#explode
     ...
     */
    egame.Particles.Arcade.Emitter.prototype.explode = function(lifespan, quantity) {
     ...
     * 
     * @method egame.Particles.Arcade.Emitter#flow
     * @param {number} [lifespan=0] - How long each particle lives once emitted in ms. 0 = forever.
     ...
     */
    egame.Particles.Arcade.Emitter.prototype.flow = function(lifespan, frequency, quantity, total, immediate) {
     ...
     * 
     * @method egame.Particles.Arcade.Emitter#start
     ...
     */
    egame.Particles.Arcade.Emitter.prototype.start = function(explode, lifespan, frequency, quantity, forceQuantity) {
     ...
     *
     * @method egame.Particles.Arcade.Emitter#emitParticle
     ...
     * @param {string|egame.RenderTexture|egame.BitmapData|egame.Video|PIXI.Texture} [key] - This is the image or texture used by the Particle during rendering. It can be a string which is a reference to the Cache Image entry, or an instance of a RenderTexture, BitmapData, Video or PIXI.Texture.
     ...
     */
    egame.Particles.Arcade.Emitter.prototype.emitParticle = function(x, y, key, frame) {
        if (x === undefined) {
            x = null;
        }
        if (y === undefined) {
     ...
     * 
     * @method egame.Particles.Arcade.Emitter#destroy
     */
    egame.Particles.Arcade.Emitter.prototype.destroy = function() {

        this.game.particles.remove(this);

        egame.Group.prototype.destroy.call(this, true, false);
     ...
     * 
     * @method egame.Particles.Arcade.Emitter#setSize
     ...
     */
    egame.Particles.Arcade.Emitter.prototype.setSize = function(width, height) {
     ...
     * @method egame.Particles.Arcade.Emitter#setXSpeed
     * @param {number} [min=0] - The minimum value for this range.
     * @param {number} [max=0] - The maximum value for this range.
     */
    egame.Particles.Arcade.Emitter.prototype.setXSpeed = function(min, max) {
     ...
     * @method egame.Particles.Arcade.Emitter#setYSpeed
     * @param {number} [min=0] - The minimum value for this range.
     * @param {number} [max=0] - The maximum value for this range.
     */
    egame.Particles.Arcade.Emitter.prototype.setYSpeed = function(min, max) {
     ...
     *
     * @method egame.Particles.Arcade.Emitter#setRotation
     * @param {number} [min=0] - The minimum value for this range.
     * @param {number} [max=0] - The maximum value for this range.
     */
    egame.Particles.Arcade.Emitter.prototype.setRotation = function(min, max) {
     ...
     *
     * @method egame.Particles.Arcade.Emitter#setAlpha
     ...
     * @param {function} [ease=egame.Easing.Linear.None] - If you've set a rate > 0 this is the easing formula applied between the min and max values.
     ...
     */
    egame.Particles.Arcade.Emitter.prototype.setAlpha = function(min, max, rate, ease, yoyo) {
     ...
     *
     * @method egame.Particles.Arcade.Emitter#setScale
     ...
     * @param {boolean} [yoyo=false] - If you've set a rate > 0 you can set if the ease will yoyo or not (i.e. ease back to its original values)
     */
    egame.Particles.Arcade.Emitter.prototype.setScale = function(minX, maxX, minY, maxY, rate, ease, yoyo) {
        if (minX === undefined) {
            minX = 1;
        }
        if (maxX === undefined) {
     ...
     *
     * @method egame.Particles.Arcade.Emitter#at
     * @param {object|egame.Sprite|egame.Image|egame.TileSprite|egame.Text|PIXI.DisplayObject} object - The object that you wish to match the center with.
     */
    egame.Particles.Arcade.Emitter.prototype.at = function(object) {
    ...
    /**
     * @name egame.Particles.Arcade.Emitter#x
     * @property {number} x - Gets or sets the x position of the Emitter.
     */
    Object.defineProperty(egame.Particles.Arcade.Emitter.prototype, "x", {
    ...
    /**
     * @name egame.Particles.Arcade.Emitter#y
     * @property {number} y - Gets or sets the y position of the Emitter.
     */
    Object.defineProperty(egame.Particles.Arcade.Emitter.prototype, "y", {
    ...
    /**
     * @name egame.Particles.Arcade.Emitter#left
     * @property {number} left - Gets the left position of the Emitter.
     * @readonly
     */
    Object.defineProperty(egame.Particles.Arcade.Emitter.prototype, "left", {
    ...
    /**
     * @name egame.Particles.Arcade.Emitter#right
     * @property {number} right - Gets the right position of the Emitter.
     * @readonly
     */
    Object.defineProperty(egame.Particles.Arcade.Emitter.prototype, "right", {
    ...
    /**
     * @name egame.Particles.Arcade.Emitter#top
     * @property {number} top - Gets the top position of the Emitter.
     * @readonly
     */
    Object.defineProperty(egame.Particles.Arcade.Emitter.prototype, "top", {
    ...
    /**
     * @name egame.Particles.Arcade.Emitter#bottom
     * @property {number} bottom - Gets the bottom position of the Emitter.
     * @readonly
     */
    Object.defineProperty(egame.Particles.Arcade.Emitter.prototype, "bottom", {
