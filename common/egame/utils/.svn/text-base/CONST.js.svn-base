egame.define("CONST", function() {
    /**
     * Constant values used in egame
     *
     * @lends egame
     */
    var CONST = {
        /**
         * String of the current egame version
         *
         * @static
         * @constant
        ...
        /**
         * Various blend modes supported by egame. IMPORTANT - The WebGL renderer only supports
        ...
        /**
         * The scale modes that are supported by egame.
         *
        ...
        /**
         * The default render options if none are supplied to {@link egame.WebGLRenderer}
         * or {@link egame.CanvasRenderer}.
         *
         * @static
         * @constant
