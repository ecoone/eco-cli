/*
 * eco.js生态框架打包专用 (https://github.com/ecoone/ecojs)
...
(function(global, undefined) {
        ...
        (function(module) {
          ...
          util.request(url, function(error) {
            ...
            if (url.indexOf(".css") != -1) {
              ...
              //package niu
              var realModule = module.nameSpace.searchModuleById(module.id);
              realModule.url = url;
  ...
  function createPackage(){
       //添加依赖发送功能 package niu
      setTimeout(function(){
          var o ={
            css:[],
            js:[]
          };
          for(var i=0;i<eco.packSeqs.length;i++){
            var module = eco.packSeqs[i];
            var url = module.url;
            if(url.indexOf('.css')!=-1){
              o.css.push(url);
            }else{
          ...
          o.css = o.css.join(",");
          o.js = o.js.join(",");
          o.pageName = getQueryString('pageName');
